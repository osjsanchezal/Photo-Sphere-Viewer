...
import { AbstractPlugin, PluginConstructor } from './dist/plugins/AbstractPlugin';
...
export class Viewer extends EventEmitter {
   ...
   */
  setPanorama(panorama: string | string[] | Cubemap, options?: PanoramaOptions): Promise<void>;
   ...
   */
  on(e: 'before-render', cb: (e: Event, timestamp: number) => void): this;
  /**
